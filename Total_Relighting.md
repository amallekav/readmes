...
- **result/**: Stores relighted images generated by the model.
...
4. **Use the Interactive RGB Slider Tool**:
   ...
   - Launch the tool and use the RGB sliders to adjust the image lighting in real-time:
...
5. **View and Save Results**:
   - After adjustments, save the customized relighted portrait. The final images will be stored in the `result` folder.
   - You can view the relighted portraits in the notebook or download them for further use.

6. **Download Results (if in Google Colab)**:
   - To download the final relighted images from the `result` folder, use the following code:
     ```python
     from google.colab import files
     files.download('DPR-master/result/output_image.jpg')  # Replace 'output_image.jpg' with your filename
     ```
**Notes**
